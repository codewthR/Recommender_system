...
# Load images
img_contact = Image.open("kushal_mangal.jpg")
img_contac = Image.open("animal.jpg")
img_conta = Image.open("daughter_of_wolf.jpg")
img_cont = Image.open("thenun.jpg")
img_con = Image.open("mysterious_island.jpg")
img_co = Image.open("the_black_hole.jpg")
img_c = Image.open("hacker.jpg")
img_b = Image.open("2067movie.jpg")
img_d = Image.open("piku1.jpg")
img_e = Image.open("pi.jpg")
img_f = Image.open("12fail.jpg")
img_g = Image.open("agent2.jpg")
img_h = Image.open("goodbye.jpg")
img_i = Image.open("spykids2.jpg")
